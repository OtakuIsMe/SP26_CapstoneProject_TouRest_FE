...
import ViewServiceModal from "@/components/features/services/ViewServiceModal";
import EditServiceModal from "@/components/features/services/EditServiceModal";
...
const columns: ColumnDef<ServiceDTO>[] = [
    ...
    },
    {
        ...
        render: (row) => (
            <div className={styles.priceCell}>
                <span className={styles.price}>{row.price.toLocaleString("vi-VN")}đ</span>
                {row.basePrice !== row.price && (
                    <span className={styles.basePrice}>{row.basePrice.toLocaleString("vi-VN")}đ</span>
                )}
            </div>
        ),
    },
    ...
    },
    {
        key: "createdAt",
        label: "Created",
        render: (row) => <span>{row.createdAt ? new Date(row.createdAt).toLocaleDateString("en-GB") : "—"}</span>,
    },
];
